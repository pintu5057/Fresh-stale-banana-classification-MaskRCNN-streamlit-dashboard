...
st.title('Fresh Banana/ Stale Banana detection App')
st.subheader('An intial prototype by Priyabrata Karmakar for the interview of Research Associate, Digital Sensing')
...
uploaded_file = st.file_uploader("Upload file", type=["csv", "png", "jpg"])
...
#img = cv2.imread(r'D:\Fruit_Veggies_detection\Sample_data\val\rotated_by_15_Screen Shot 2018-06-12 at 9.43.59 PM.png')
...
# define the model
    ...
    img = cv2.cvtColor(img, cv2.COLOR_RGB2BGR) # Convert RGB image back to BGR
    
    st.image(img, channels="BGR", width=500, caption='Target Image')
